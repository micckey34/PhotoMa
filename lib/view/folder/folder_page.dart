...
import '../../components/folder/share_folder.dart';
import '../../components/folder/upload_file.dart';

class FolderPage extends StatefulWidget {
  final int id;
  final String folderName;

  FolderPage({this.id, this.folderName});
                                      ...
                                      ElevatedButton(
                                          onPressed: () async {
                                            ...
                                            Navigator.pushReplacement(
                                              context,
                                              MaterialPageRoute(builder: (context) => FolderPage(id: id,folderName: folderName,)),
                                            );
                                          },
                                          child: Text('削除'),
